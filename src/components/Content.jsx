...
export function Content() {
  ...
  const baseURL = 'https://back-end-rawc.onrender.com/mulheres'
  ...
  return (
    <>
      <Header
        title='Mulheres pretas que inspiram'
        subtitle='Conheça personalidades femininas pretas que estão transformando o mundo'
        image={listaImg}
      />
